...
export const Settings = () => {
  const { tags, defaultTag, addTag, editTag, deleteTag, updateDefaultTag } = useTags();

  // Tags CRUD local state
  const [newTagInput, setNewTagInput] = useState('');
  const [editingTag, setEditingTag] = useState(null); // { original, value }
  ...
  const handleEditSave = () => {
    if (editingTag && editingTag.value.trim()) {
      editTag(editingTag.original, editingTag.value.trim());
      setEditingTag(null);
    }
  };
    ...
    <div className="settings-container">
      <div className="settings-card">
        ...
        <div className="settings-section">
          ...
          {/* Default Project Tag */}
          <div className="settings-item">
            <label htmlFor="defaultProjectTag">Default Project Tag</label>
            <select
              id="defaultProjectTag"
              value={defaultTag}
              onChange={(e) => updateDefaultTag(e.target.value)}
            >
          ...
          {/* Define Custom Tags */}
          <div className="settings-item">
            <label>Define Custom Tags</label>
            <div className="custom-tags-list">
              {tags.map((tag) => (
                <div key={tag} className="custom-tag-row">
                  ...
                  <div className="tag-actions">
                    {editingTag?.original === tag ? (
                      ...
                      <button
                        ...
                        onClick={() => setEditingTag({ original: tag, value: tag })}
                        title="Edit tag"
                      >✏️</button>
                    )}
                    <button
